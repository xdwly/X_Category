...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xdwly/X_Category"
  ...
  s.source       = { :git => "https://github.com/xdwly/X_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "X_Category/X_Category/**/*.{h,m,swift}"
